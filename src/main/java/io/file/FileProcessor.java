 ...
 * file. It checks the format and validity of the data for both {@link main_objects.Flat} and {@link
 * main_objects.House} objects. It uses {@link ObjInputChecker} to perform specific checks on
