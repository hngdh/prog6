 ...
 * provides invalid input within a file. It extends the {@code Exception} class
 * and provides a specific error message to inform the user about the invalid input within
 * a file.
 */
